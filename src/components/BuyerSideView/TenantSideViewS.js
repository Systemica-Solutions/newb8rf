...
import TenantSideViewCompS from "./TenantSideViewCompS";
import CommonBtn from "../CommonButton";

//export  {globalTenantId};
let globalBuyerId;

function TenantSideViewS() {
  ...
  useEffect(() => {
    const fetchBoardDetails = async () => {
      ...
      try {
        ...
        // const responseData = response.data.data.tenant.tenantDetails;
        // const responseDataBoardData = response.data.data.board;
        const responseDataBuyerData = response.data.data.buyer;
        setResponseDataBuyerName(
          response.data.data.buyer.buyerDetails[0].name
        );
  ...
  return (
    <>
      ...
      <TenantSideViewCompS boards={responseDataProperty} boardId={boardId} boardData={responseDataBoard} />
...
export default TenantSideViewS;
export { globalBuyerId };
