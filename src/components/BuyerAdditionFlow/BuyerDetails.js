...
function BuyerDetails() {
  ...
  const handleSubmit = (event) => {
    ...
    console.log();
    axios
      .post("https://b8rliving.com/tenantpref", formData)
      .then((response) => {
    ...
    <div className="login-page">
      ...
      >
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <select
            name="type_of_furnishing"
            id="furnishing"
            value={formData.type_of_furnishing}
            onChange={handleChange}
            style={{
              backgroundColor: "white",
              padding: "10px",
          ...
          >
            ...
            <option value="standalonehouse">Standalone Individual House</option>
          </select>
