      ...
      <BrowserRouter>
        <div>
          <Routes>
            ...
            <Route exact path="adminFront/addImage" element={<AddImage />} />
            <Route exact path="adminFront/assignProperty" element={<AssignProperty />} />
            ...
            <Route
              exact
              path="EditPropertyInfo"
              element={<EditPropertyInfo />}
            />
